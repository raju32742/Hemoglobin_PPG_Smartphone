...
df = pd.read_csv("./LED-0940_7_lbs.csv")
df.shape
df.head()
df.columns
...
pop = fsga.generate(50, 100) ## population size and Generation = 10,50 (200, 100)
pp = fsga.plot_feature_set_score(100, L_nam="LED-0940_feat") ## Generation
...
######### check it
print("Overall R for Hemoglobin for LED-0940: " + str(pearsonr(y[:, 0],cv_set[:, 0])))
...
#bland_altman_plot(y_real, cv_set_pred, "hb-0940")
 
print("Performance for Hemoglobin of LED-0940: ")
...
################# ====== plot bland_altman_plot
bland_altman_plot(y_real, cv_set_pred, name="hemo-0940_bland")

##### === Plot estimated and predicted
r = pearsonr(y_real, cv_set_pred)
act_pred_plot(y_real, cv_set_pred, r, name="hemo-0940_act_pred")
...
print("Performance for Glucose of LED-0940: ")
print("R: " + str(pearsonr(y_real,cv_set_pred)))
print("R^2 Score: " + str(metrics.r2_score(y_real,cv_set_pred)))
print("MAE: " + str(metrics.mean_absolute_error(y_real,cv_set_pred)))
print("MSE: " + str(metrics.mean_squared_error(y_real,cv_set_pred)))
...
################# ====== plot bland_altman_plot
bland_altman_plot(y_real, cv_set_pred, name="Glucose-0940_bland")

##### === Plot estimated and predicted
r = pearsonr(y_real, cv_set_pred)
act_pred_plot(y_real, cv_set_pred, r, name="Glucose-0940_act_pred")
...
print("Performance for HbA1c of LED-0940: ")
print("R: " + str(pearsonr(y_real,cv_set_pred)))
print("R^2 Score: " + str(metrics.r2_score(y_real,cv_set_pred)))
print("MAE: " + str(metrics.mean_absolute_error(y_real,cv_set_pred)))
print("MSE: " + str(metrics.mean_squared_error(y_real,cv_set_pred)))
...
################# ====== plot bland_altman_plot
bland_altman_plot(y_real, cv_set_pred, name="HbA1c-0940_bland")

##### === Plot estimated and predicted
r = pearsonr(y_real, cv_set_pred)
act_pred_plot(y_real, cv_set_pred, r, name="HbA1c-0940_act_pred")
...
print("Performance for Creatinine of LED-0940: ")
print("R: " + str(pearsonr(y_real,cv_set_pred)))
print("R^2 Score: " + str(metrics.r2_score(y_real,cv_set_pred)))
print("MAE: " + str(metrics.mean_absolute_error(y_real,cv_set_pred)))
print("MSE: " + str(metrics.mean_squared_error(y_real,cv_set_pred)))
...
################# ====== plot bland_altman_plot
bland_altman_plot(y_real, cv_set_pred, name="Creatinine-0940_bland")

##### === Plot estimated and predicted
r = pearsonr(y_real, cv_set_pred)
act_pred_plot(y_real, cv_set_pred, r, name="Creatinine-0940_act_pred")
...
print("Performance for BUN of LED-0940: ")
print("R: " + str(pearsonr(y_real,cv_set_pred)))
print("R^2 Score: " + str(metrics.r2_score(y_real,cv_set_pred)))
print("MAE: " + str(metrics.mean_absolute_error(y_real,cv_set_pred)))
print("MSE: " + str(metrics.mean_squared_error(y_real,cv_set_pred)))
...
################# ====== plot bland_altman_plot
bland_altman_plot(y_real, cv_set_pred, name="BUN-0940_bland")

##### === Plot estimated and predicted
r = pearsonr(y_real, cv_set_pred)
act_pred_plot(y_real, cv_set_pred, r, name="BUN-0940_act_pred")
...
print("Performance for SPO2 of LED-0940: ")
print("R: " + str(pearsonr(y_real,cv_set_pred)))
print("R^2 Score: " + str(metrics.r2_score(y_real,cv_set_pred)))
print("MAE: " + str(metrics.mean_absolute_error(y_real,cv_set_pred)))
print("MSE: " + str(metrics.mean_squared_error(y_real,cv_set_pred)))
...
################# ====== plot bland_altman_plot
bland_altman_plot(y_real, cv_set_pred, name="SPO2-0940_bland")

##### === Plot estimated and predicted
r = pearsonr(y_real, cv_set_pred)
act_pred_plot(y_real, cv_set_pred, r, name="SPO2-0940_act_pred")
...
print("Performance for BPM of LED-0940: ")
print("R: " + str(pearsonr(y_real,cv_set_pred)))
print("R^2 Score: " + str(metrics.r2_score(y_real,cv_set_pred)))
print("MAE: " + str(metrics.mean_absolute_error(y_real,cv_set_pred)))
print("MSE: " + str(metrics.mean_squared_error(y_real,cv_set_pred)))
...
################# ====== plot bland_altman_plot
bland_altman_plot(y_real, cv_set_pred, name="BPM-0940_bland")

##### === Plot estimated and predicted
r = pearsonr(y_real, cv_set_pred)
act_pred_plot(y_real, cv_set_pred, r, name="BPM-0940_act_pred")
