...
df = pd.read_csv("./LED-NO_7_lbs.csv")
df.shape
df.head()
df.columns
...
pp = fsga.plot_feature_set_score(100, L_nam="LED-NO_feat") ## Generation
...
######### check it
print("Overall R for Hemoglobin for LED-NO: " + str(pearsonr(y[:, 0],cv_set[:, 0])))
...
#bland_altman_plot(y_real, cv_set_pred, "hb-NO")
 
print("Performance for Hemoglobin of LED-NO: ")
...
################# ====== plot bland_altman_plot
bland_altman_plot(y_real, cv_set_pred, name="hemo-NO_bland")

##### === Plot estimated and predicted
r = pearsonr(y_real, cv_set_pred)
act_pred_plot(y_real, cv_set_pred, r, name="hemo-NO_act_pred")
...
print("Performance for Glucose of LED-NO: ")
print("R: " + str(pearsonr(y_real,cv_set_pred)))
print("R^2 Score: " + str(metrics.r2_score(y_real,cv_set_pred)))
print("MAE: " + str(metrics.mean_absolute_error(y_real,cv_set_pred)))
print("MSE: " + str(metrics.mean_squared_error(y_real,cv_set_pred)))
...
################# ====== plot bland_altman_plot
bland_altman_plot(y_real, cv_set_pred, name="Glucose-NO_bland")

##### === Plot estimated and predicted
r = pearsonr(y_real, cv_set_pred)
act_pred_plot(y_real, cv_set_pred, r, name="Glucose-NO_act_pred")
...
print("Performance for HbA1c of LED-NO: ")
print("R: " + str(pearsonr(y_real,cv_set_pred)))
print("R^2 Score: " + str(metrics.r2_score(y_real,cv_set_pred)))
print("MAE: " + str(metrics.mean_absolute_error(y_real,cv_set_pred)))
print("MSE: " + str(metrics.mean_squared_error(y_real,cv_set_pred)))
...
################# ====== plot bland_altman_plot
bland_altman_plot(y_real, cv_set_pred, name="HbA1c-NO_bland")

##### === Plot estimated and predicted
r = pearsonr(y_real, cv_set_pred)
act_pred_plot(y_real, cv_set_pred, r, name="HbA1c-NO_act_pred")
...
print("Performance for Creatinine of LED-NO: ")
print("R: " + str(pearsonr(y_real,cv_set_pred)))
print("R^2 Score: " + str(metrics.r2_score(y_real,cv_set_pred)))
print("MAE: " + str(metrics.mean_absolute_error(y_real,cv_set_pred)))
print("MSE: " + str(metrics.mean_squared_error(y_real,cv_set_pred)))
...
################# ====== plot bland_altman_plot
bland_altman_plot(y_real, cv_set_pred, name="Creatinine-NO_bland")

##### === Plot estimated and predicted
r = pearsonr(y_real, cv_set_pred)
act_pred_plot(y_real, cv_set_pred, r, name="Creatinine-NO_act_pred")
...
print("Performance for BUN of LED-NO: ")
print("R: " + str(pearsonr(y_real,cv_set_pred)))
print("R^2 Score: " + str(metrics.r2_score(y_real,cv_set_pred)))
print("MAE: " + str(metrics.mean_absolute_error(y_real,cv_set_pred)))
print("MSE: " + str(metrics.mean_squared_error(y_real,cv_set_pred)))
...
################# ====== plot bland_altman_plot
bland_altman_plot(y_real, cv_set_pred, name="BUN-NO_bland")

##### === Plot estimated and predicted
r = pearsonr(y_real, cv_set_pred)
act_pred_plot(y_real, cv_set_pred, r, name="BUN-NO_act_pred")
...
print("Performance for SPO2 of LED-NO: ")
print("R: " + str(pearsonr(y_real,cv_set_pred)))
print("R^2 Score: " + str(metrics.r2_score(y_real,cv_set_pred)))
print("MAE: " + str(metrics.mean_absolute_error(y_real,cv_set_pred)))
print("MSE: " + str(metrics.mean_squared_error(y_real,cv_set_pred)))
...
################# ====== plot bland_altman_plot
bland_altman_plot(y_real, cv_set_pred, name="SPO2-NO_bland")

##### === Plot estimated and predicted
r = pearsonr(y_real, cv_set_pred)
act_pred_plot(y_real, cv_set_pred, r, name="SPO2-NO_act_pred")
...
print("Performance for BPM of LED-NO: ")
print("R: " + str(pearsonr(y_real,cv_set_pred)))
print("R^2 Score: " + str(metrics.r2_score(y_real,cv_set_pred)))
print("MAE: " + str(metrics.mean_absolute_error(y_real,cv_set_pred)))
print("MSE: " + str(metrics.mean_squared_error(y_real,cv_set_pred)))
...
################# ====== plot bland_altman_plot
bland_altman_plot(y_real, cv_set_pred, name="BPM-NO_bland")

##### === Plot estimated and predicted
r = pearsonr(y_real, cv_set_pred)
act_pred_plot(y_real, cv_set_pred, r, name="BPM-NO_act_pred")
